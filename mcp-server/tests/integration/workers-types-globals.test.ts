...
const DECLARED_GLOBALS: ReadonlySet<string> = new Set([
  ...
  // +5.20260830.1 — seven Workers AI model catalogue types (Deepseek V4,
  // Moondream 3, Kimi K2.7 Code, Qwen3 8/27B, GLM 5.x). Model names, nothing
  // @types/node declares; checked against its globals.d.ts on the bump.
  'Base_Ai_Cf_Deepseek_Ai_Deepseek_V4_Flash_0731',
  'Base_Ai_Cf_Deepseek_Ai_Deepseek_V4_Pro_0813',
  ...
  'Base_Ai_Cf_Moondream_Moondream3_1_9B_A2B',
  'Base_Ai_Cf_Moonshotai_Kimi_K2_5',
  'Base_Ai_Cf_Moonshotai_Kimi_K2_6',
  'Base_Ai_Cf_Moonshotai_Kimi_K2_7_Code',
  ...
  'Base_Ai_Cf_Zai_Org_Glm_5_2',
  'Base_Ai_Cf_Zai_Org_Glm_5_3_Flash',
  'Blob',
  'Body',
  'BrowserRun',
