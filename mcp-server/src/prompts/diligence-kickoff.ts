      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              '',
              `Step 3. Frame the result as a one-page kickoff memo for ${args.targetName} in GST's house style with these sections:`,
              unknownDimensions >= 7
