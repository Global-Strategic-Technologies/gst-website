      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              '',
              `  **BL-045 PR B \`_audit\` sibling (REQUIRED — partner-supplied form variant)**: this prompt collects values from partner form input, not from a structured IRL. Supply the audit metadata as Tier-3 (no IRL provenance) with the following minimum shape — every field is mandatory by schema:`,
              '',
              '  ```json',
              '  "_audit": {',
