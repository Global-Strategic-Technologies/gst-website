/**
 * Prompt: gst_irl_populate (BL-140; renamed from gst_irl_fill in server 0.62.0)
 *
...
const PROMPT_NAME = 'gst_irl_populate';
...
export const irlPopulatePrompt: GstPrompt<typeof argsSchema> = {
  name: PROMPT_NAME,
  description:
