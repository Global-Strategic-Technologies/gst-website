...
function buildInteractiveBody(args: {
  ...
  const sharedPrefix = [
    ...
    "(That is about the operator's IRL file. The `deliveredAsDocumentClause` paragraph further up is about how THIS prompt body reached you — different subject, and its reassurance does not transfer.)",
    '',
