...
const ENVELOPE_COMPOSITION_DIRECTIVE = [
  ...
  '  - `run` — remote transport with the durable run-scoped store live; every call made against THIS IRL body is covered, across requests.',
