...
function buildOneShotBody(args: {
  ...
  return [
    ...
    '    "arr":                { "annualizationSource": "ytd-annualized-with-period", "ytdMonths": 3, "citation": "Section 00 row 10 — Recurring $2.64M CAD/mo Apr-2026 × 3-month YTD = $7.86M YTD → annualize × 4 = $31.7M CAD ⇒ $22.6M USD" },',
    ...
    '    "rdOpEx":             { "annualizationSource": "ytd-annualized-with-period", "ytdMonths": 3, "citation": "Section 02 row 47 — R&D $2.42M YTD CAD (3-month YTD) × 4 = $9.68M CAD ⇒ $7.07M USD; using $9.68M as quick-mode rdOpEx in CAD-basis bracket" },',
