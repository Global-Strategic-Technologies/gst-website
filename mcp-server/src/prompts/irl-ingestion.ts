...
function buildOneShotBody(args: {
  ...
  // Worked-example JSON megapayloads for Steps 1a / 4a / 6a are permanently
  // elided — the calibration prose plus each tool's structured rejection
  // diagnostic carry first-call shape discipline.
  const embedExamples = false;
