...
const ARRIVAL_AND_INFERENCE = [
  ...
  '',
  '**Arriving with no accompanying message is not ambiguity.** The invocation is the instruction: when this body and an IRL are in front of you with nothing else said, run the mode stated in Run parameters — do not stop to ask whether a run or a review of the prompt was intended.',
  '',
