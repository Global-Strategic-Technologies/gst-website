...
> - **Canonical question source**: [`src/data/library/information-request-list/article.md`](../../../../../src/data/library/information-request-list/article.md), surfaced as the `gst://library/information-request-list` resource.
