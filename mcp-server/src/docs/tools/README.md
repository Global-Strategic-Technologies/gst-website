...
| IRL fill               | `fill_information_request_list_xlsx`                                                                                                     | [`irl-fill/CONTRACT.md`](irl-fill/CONTRACT.md)                                                 | ✅ Authored (BL-140); own dir because the frozen five-tool family contract predates it — [`irl-fill/USAGE.md`](irl-fill/USAGE.md) authored alongside    |
