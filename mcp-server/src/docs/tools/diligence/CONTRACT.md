...
- [BL-031 initiative (archived)](../../../../../src/docs/development/_archive/MCP_SERVER_ARCHITECTURE_BL-031.md) — the initiative that ships the underlying tool
- [BL-031.85 initiative (archived)](../../../../../src/docs/development/_archive/MCP_SERVER_CONTRACTS_BL-031_85.md) — the initiative that ships this contract
