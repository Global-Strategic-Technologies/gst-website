...
>
> **Used by prompt**: `gst_irl_populate` (`gst_irl_fill` → `gst_irl_create` in 0.62.0 → `gst_irl_populate` in 0.63.0; see [`prompts/README.md`](../../prompts/README.md)) — evidence inventory → authored fills → this tool → **stop at the artifact**.
>
