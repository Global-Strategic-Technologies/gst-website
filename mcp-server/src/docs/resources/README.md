...
| **Regulations** | `gst://regulations/<jurisdiction>/<framework-id>`                                  | [`../../resources/regulations.ts`](../../resources/regulations.ts) | One Resource per regulatory framework (123), JSON-serialized full `Regulation` schema. `application/json`.                                                   |
