...
| Column    | Field                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `blob1`   | `event_type` — the thirteen declared in `metrics/_schema.ts`: `tool_invocation` / `resource_read` / `prompt_invocation` / `prompt_span` / `rate_limit_decision` / `inoreader_call` / `health_check` / `cron_outcome` / `audit_batch` / `wrong_irl_detected` / `gate_elided` / `trial_signup` / `tier_denial`. **Four of these emit nothing in production** — `health_check` has no emitter at all; `prompt_span`, `wrong_irl_detected` and `gate_elided` have emitters nothing calls (BL-157). `rate_limit_decision` emits on **refusal only**, never `allow` (ADR-0032) |
