...
| Column    | Field                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `blob1`   | `event_type` — the twelve declared in `metrics/_schema.ts`: `tool_invocation` / `resource_read` / `prompt_invocation` / `prompt_span` / `rate_limit_decision` / `inoreader_call` / `health_check` / `cron_outcome` / `audit_batch` / `wrong_irl_detected` / `gate_elided` / `trial_signup`. **Five of these emit nothing in production** — `rate_limit_decision` and `health_check` have no emitter at all; `prompt_span`, `wrong_irl_detected` and `gate_elided` have emitters nothing calls (BL-157) |
