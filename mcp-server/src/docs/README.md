...
| Area           | Doc                                      | What's there                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| -------------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Operations** | [`operations/`](operations/)             | Live runbooks: [`AUTH.md`](operations/AUTH.md), [`PILOT_ONBOARDING.md`](operations/PILOT_ONBOARDING.md), [`DEPLOY.md`](operations/DEPLOY.md), [`RATE_LIMITS.md`](operations/RATE_LIMITS.md), [`REMOTE_CLIENT_SETUP.md`](operations/REMOTE_CLIENT_SETUP.md), [`AUDIT_LOG.md`](operations/AUDIT_LOG.md), [`STATUS_PAGE.md`](operations/STATUS_PAGE.md), [`LATENCY_PROBE.md`](operations/LATENCY_PROBE.md), [`SENTRY_ALERT_RULES.md`](operations/SENTRY_ALERT_RULES.md), [`GRAFANA.md`](operations/GRAFANA.md), [`INOREADER_OAUTH_CONTRACT.md`](operations/INOREADER_OAUTH_CONTRACT.md). Closed-initiative trackers live in [`operations/_archive/`](operations/_archive/). |
| **Testing**    | [`testing/README.md`](testing/README.md) | Two bands. **Automated**: what the Vitest suite covers, how to run it, how to add a test. **Human acceptance**: [`testing/uat/README.md`](testing/uat/README.md) — the index of every UAT walkthrough proving the deployed server from a real client, starting at [`testing/uat/SETUP.md`](testing/uat/SETUP.md).                                                                                                                                                                                                                                                                                                                                                        |
