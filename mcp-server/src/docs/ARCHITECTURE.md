...
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --- | --------- | ----------------------------------------------------------- |
| `blob1` | `event_type` (discriminator: `tool_invocation`, `resource_read`, `prompt_invocation`, `rate_limit_decision`, `inoreader_call`, `cron_outcome`, `audit_batch`, `wrong_irl_detected`, `gate_elided`, `trial_signup`, `tier_denial`, `scope_denial`, `oauth_consent`) |     | `blob6`   | `status_code` (string)                                      |
...
| `blob5` | `correlation_id` (reserved — no writer, BL-157)                                                                                                                                                                                                                    |     | `double2` | `seq` (`audit_batch` entry count)                           |
