...
### Tools (11; counting the deprecated `search_radar_cache` alias retained one release)
...
| `gst://library/information-request-list` | GST one-page intake checklist (VDR-9 + Engagement Basics)                             | `text/markdown`    | 1     | `gst_information_request_list` (embedded as second message; bullets reproduced verbatim)                      |
...
| `gst_information_request_list`    | `{ targetName?, transactionContext?, productSummary? }` (all optional)               | `gst://library/information-request-list`                                         | Paste-ready one-page intake checklist (VDR-9 taxonomy + Engagement Basics prelude). Pair with `gst_diligence_kickoff` once filled. |
