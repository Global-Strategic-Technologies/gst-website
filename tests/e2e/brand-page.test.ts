...
test.describe('Brand Page', () => {
  ...
  // The "No orphan classes" check that lived here (28 phantom specimen classes
  // found on /brand) now runs site-wide from accessibility.test.ts via
  // helpers/orphan-classes.ts (BL-116), with /brand's JS hooks carried over into
  // its ALLOWED_UNSTYLED map — and, unlike here, a stale entry now fails.
