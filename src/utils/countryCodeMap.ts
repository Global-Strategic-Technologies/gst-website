...
export const numericToAlpha3: Record<string, string> = {
  ...
  '496': 'MNG', '498': 'MDA', '504': 'MAR', '508': 'MOZ', '512': 'OMN',
  ...
  '682': 'SAU', '686': 'SEN', '694': 'SLE', '702': 'SGP', '703': 'SVK',
...
export const alpha3ToName: Record<string, string> = {
  ...
  'CAF': 'Central African Republic', 'LKA': 'Sri Lanka', 'TCD': 'Chad',
  'CHL': 'Chile', 'CHN': 'China', 'COL': 'Colombia', 'COG': 'Republic of the Congo',
  'COD': 'Democratic Republic of the Congo', 'CRI': 'Costa Rica', 'HRV': 'Croatia',
  'CUB': 'Cuba', 'CYP': 'Cyprus', 'CZE': 'Czech Republic', 'BEN': 'Benin',
  'DNK': 'Denmark', 'DOM': 'Dominican Republic', 'ECU': 'Ecuador',
  'SLV': 'El Salvador', 'GNQ': 'Equatorial Guinea', 'ETH': 'Ethiopia',
  'ERI': 'Eritrea', 'EST': 'Estonia', 'FJI': 'Fiji', 'FIN': 'Finland',
  'FRA': 'France', 'ATF': 'French Southern Territories', 'DJI': 'Djibouti',
  'GAB': 'Gabon', 'GEO': 'Georgia', 'GMB': 'Gambia', 'PSE': 'Palestine',
  'DEU': 'Germany', 'GHA': 'Ghana', 'KIR': 'Kiribati', 'GRC': 'Greece',
  'GRL': 'Greenland', 'GTM': 'Guatemala', 'GIN': 'Guinea', 'GUY': 'Guyana',
  ...
  'JAM': 'Jamaica', 'JPN': 'Japan', 'KAZ': 'Kazakhstan', 'JOR': 'Jordan',
  'KEN': 'Kenya', 'PRK': 'North Korea', 'KOR': 'South Korea', 'KWT': 'Kuwait',
  'KGZ': 'Kyrgyzstan', 'LAO': 'Laos', 'LBN': 'Lebanon', 'LSO': 'Lesotho',
  'LVA': 'Latvia', 'LBR': 'Liberia', 'LBY': 'Libya', 'LTU': 'Lithuania',
  'LUX': 'Luxembourg', 'MDG': 'Madagascar', 'MWI': 'Malawi', 'MYS': 'Malaysia',
  'MDV': 'Maldives', 'MLI': 'Mali', 'MLT': 'Malta', 'MRT': 'Mauritania',
  'MUS': 'Mauritius', 'MEX': 'Mexico', 'MNG': 'Mongolia', 'MDA': 'Moldova',
  'MAR': 'Morocco', 'MOZ': 'Mozambique', 'OMN': 'Oman', 'NAM': 'Namibia',
  'NPL': 'Nepal', 'NLD': 'Netherlands', 'NCL': 'New Caledonia', 'VUT': 'Vanuatu',
  ...
  'PRT': 'Portugal', 'GNB': 'Guinea-Bissau', 'TLS': 'East Timor',
  'PRI': 'Puerto Rico', 'QAT': 'Qatar', 'ROU': 'Romania', 'RUS': 'Russia',
  'RWA': 'Rwanda', 'SAU': 'Saudi Arabia', 'SEN': 'Senegal',
  'SLE': 'Sierra Leone', 'SGP': 'Singapore', 'SVK': 'Slovakia', 'VNM': 'Vietnam',
  'SVN': 'Slovenia', 'SOM': 'Somalia', 'ZAF': 'South Africa', 'ZWE': 'Zimbabwe',
  'ESP': 'Spain', 'SSD': 'South Sudan', 'SDN': 'Sudan', 'ESH': 'Western Sahara',
  'SUR': 'Suriname', 'SWZ': 'Eswatini', 'SWE': 'Sweden', 'CHE': 'Switzerland',
  'SYR': 'Syria', 'TJK': 'Tajikistan', 'THA': 'Thailand', 'TGO': 'Togo',
  'TTO': 'Trinidad and Tobago', 'ARE': 'United Arab Emirates', 'TUN': 'Tunisia',
