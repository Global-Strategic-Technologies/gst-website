...
| ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | ------------------------------------------------------- |
| [adr/](adr/)                   | Architecture Decision Records — load-bearing design decisions distilled from closed initiatives                                                                                                 | 37                            | [README.md](adr/README.md)                              |
| [analytics/](analytics/)       | GA4 integration, event tracking                                                                                                                                                                 | 2                             | [README.md](analytics/README.md)                        |
| [architecture/](architecture/) | The whole estate — website + MCP server — mapped in the five layers of the Business Architectures article, with mermaid diagrams                                                                | 5                             | [README.md](architecture/README.md)                     |
| [development/](development/)   | Roadmap, tooling, active initiatives (closed-initiative docs distill + archive per the [lifecycle](development/README.md#initiative-doc-lifecycle-convention-codified-2026-07-15-under-bl-088)) | 8 living + 3 open initiatives | [README.md](development/README.md)                      |
