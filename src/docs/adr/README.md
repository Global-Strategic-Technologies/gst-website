...
| [0013](0013-mcp-2026-07-28-modern-only-worker.md)        | MCP Worker serves `2026-07-28` only; stdio keeps the legacy era; `cors.ts` owns origin policy | Accepted 2026-08-03 (BL-106, 0.44.0)                                                                       |
