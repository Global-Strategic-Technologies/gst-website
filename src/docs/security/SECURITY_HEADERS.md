...
| connect-src               | 'self' googletagmanager.com google-analytics.com analytics.google.com www.google.com \*.ingest.sentry.io \*.ingest.us.sentry.io vitals.vercel-insights.com | GA4 beacons (primary + alternate + Google Signals), Sentry error reports (US region), Vercel vitals |
