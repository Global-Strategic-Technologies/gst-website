...
>
> **Status**: In progress — PR 1 (archive wave) landed 2026-07-15. PRs 2–5 pending.
>
...
| 2   | ARCHITECTURE.md from 5 sources; archive them; repoint ~25–30 refs                                                | pending (~2–2.5 d) |
| 3a  | ADR scaffolding + ADR-0001/2/3; archive 3 sources; repoint ~15 refs                                              | pending (~1 d)     |
