...
| [.github/workflows/deploy-mcp-staging.yml](../../../.github/workflows/deploy-mcp-staging.yml) | Auto-deploys the MCP Worker to staging on a green MCP test run from a same-repo push (fork PRs refused, BL-111) (BL-037 Phase A)         |
