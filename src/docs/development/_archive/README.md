...
| [MCP_SERVER_FILLED_IRL_INGESTION_BL-045_TOOL_SCHEMA_ENFORCEMENT_SPEC.md](MCP_SERVER_FILLED_IRL_INGESTION_BL-045_TOOL_SCHEMA_ENFORCEMENT_SPEC.md) | BL-045 `_audit` schema-enforcement spec | 2026-06-02 (0.4.0) | The SanFran empirical pivot from body coaching to schema enforcement; distilled into `prompts/irl-ingestion.md` § Server-side enforcement (BL-088 PR 4) |
