...
- [ ] **T1 monitor-the-monitor — paging-channel verification**: operator confirms the notification (email currently — Slack future) arrives at the configured paging channel from the first real production cron tick (≥2026-06-01 14:00 UTC). Update SENTRY_ALERT_RULES.md § 4 with receipt timestamp
