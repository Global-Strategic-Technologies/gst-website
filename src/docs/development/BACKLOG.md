...
- [ ] Search Console: each locale verified as indexed with no hreflang errors before it is announced (ties into BL-152 Slice 0 for the English baseline; a Spanish LinkedIn post is the obvious first use of `/es/`)
